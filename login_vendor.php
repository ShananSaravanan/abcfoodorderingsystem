  ...
  <div class="container">
    ...
    <?php include 'headermenus.php'; ?>
      <div class="chef-section ml-lg-3">
          <ul class="nav">
            <li class="nav-item"><a href="#" class="nav-link text-white" style="border: 1px solid white;">VENDOR</a></li>
          </ul>
      </div>
    </div>
  </div>
            ...
            <div class="form-container">
                ...
                <div class="tab-content mt-2">
                    ...
                    <form action="login.php" method="post">
                        <input type="hidden" name="redirect_page" value="vendor_dashboard.php">
                        <input type="hidden" name="from_page" value="login_vendor.php">
                        <input type="hidden" name="tablename" value="vendor">
                  <div class="mb-3">
                  ...
                  <button type="submit" class="btn btn-primary">Login</button>
                    ...
                    <div class="tab-pane fade" id="register">
                        ...
                        <input type="hidden" name="redirect_page" value="login_vendor.php">
                        <input type="hidden" name="tablename" value="vendor">
                            <div class="mb-3">
